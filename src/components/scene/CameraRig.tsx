...
const POSES: Record<ActId, { pos: THREE.Vector3; look: THREE.Vector3 }> = {
  'cold-open': { pos: new THREE.Vector3(0, 0.35, 6.2), look: new THREE.Vector3(0, 0.15, 0) },
  swarm: { pos: new THREE.Vector3(1.4, 0.9, 5.0), look: new THREE.Vector3(0, 0.1, 0) },
  guardrail: { pos: new THREE.Vector3(0, 2.4, 4.2), look: new THREE.Vector3(0, 0, 0) },
  hefesto: { pos: new THREE.Vector3(-2.6, 0.55, 4.0), look: new THREE.Vector3(-2.1, 0.1, 0) },
  pontonet: { pos: new THREE.Vector3(2.6, 0.55, 4.0), look: new THREE.Vector3(2.1, 0.1, 0) },
  record: { pos: new THREE.Vector3(0, 0.15, 5.6), look: new THREE.Vector3(0, 0, 0) },
  cooling: { pos: new THREE.Vector3(0, -0.55, 7.2), look: new THREE.Vector3(0, -0.4, 0) },
}
